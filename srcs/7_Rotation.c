...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/29 04:08:26 by qzoli             #+#    #+#             */
/*   Updated: 2024/12/29 04:08:28 by qzoli            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_3d_mesh(t_map *map, int angle, int axis)
{
	...
	if (axis == X_AXIS)
		while (i < map->vertices)
			rotate_3d_point_x(&map->iso_mesh[i++], angle);
	else if (axis == Y_AXIS)
		while (i < map->vertices)
			rotate_3d_point_y(&map->iso_mesh[i++], angle);
	else if (axis == Z_AXIS)
		while (i < map->vertices)
			rotate_3d_point_z(&map->iso_mesh[i++], angle);
}
